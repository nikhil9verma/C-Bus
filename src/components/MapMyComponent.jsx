...
const locations = [
  ...
  { id: 2, name: 'Location 2', position: { lat: 34.0522, lng: -118.2437 } },
  { id: 3, name: 'Location 3', position: { lat: 40.7128, lng: -74.0060 } },
  { id: 4, name: 'Kharar', position: { lat: 30.750300501113628, lng: 76.64071199597718 } },
  { id: 5, name: 'ISBT 43', position: { lat: 30.71711854736046, lng: 76.74299345914386 } },
];
