...
const busData = {
  ...
  driverContact: "9812345670",
  capacity: "40 seats",
  type: "Semi-Deluxe"
};

// Bus stops for Bus 25 route from Mohali to IT Park via Chandigarh
const busStops = [
  {
    name: "Phase 8 Mohali",
...
const routeOptions = [
  { 
    ...
    stops: 5, 
    fare: "₹30",
    description: "Regular route covering all major stops between Mohali and IT Park via Sector 43 and Sector 17.",
    color: "#DC2626", // Red
    departureTime: "07:30 AM",
    arrivalTime: "09:00 AM",
    trafficCondition: "Heavy traffic during morning rush hour",
  ...
  { 
    ...
    stops: 3, 
    fare: "₹40",
    description: "Faster route that bypasses Sector 17, using Madhya Marg for quicker travel time.",
    color: "#059669", // Green
    departureTime: "07:30 AM",
    arrivalTime: "08:40 AM",
    trafficCondition: "Moderate traffic, uses Madhya Marg",
  ...
  { 
    ...
    stops: 4, 
    fare: "₹35",
    description: "Special weekend route with a stop at Sukhna Lake for tourists and weekend travelers.",
    color: "#6366F1", // Indigo
    departureTime: "09:00 AM",
    arrivalTime: "10:20 AM",
    trafficCondition: "Light traffic on weekends",
    routingPreference: "TRAFFIC_AWARE",
    avoidHighways: true,
    avoidTolls: false
  }
...
const RouteMap = memo(({ route, origin, destination, busStops, onStopSelect }) => {
  ...
  const calculateRoute = useCallback(() => {
    ...
    const filteredStops = busStops.filter(stop => {
      if (route.id === 2) {
        // Express route skips Sector 17
        return !stop.isOrigin && !stop.isDestination && 
               stop.name !== "Sector 17 Bus Stand";
      }
      return !stop.isOrigin && !stop.isDestination;
    });
    ...
    // Add Sukhna Lake as an additional waypoint for weekend route
    if (route.id === 3) {
      waypoints.push({
        location: new window.google.maps.LatLng(30.7421, 76.8182), // Sukhna Lake coordinates
        stopover: true
      });
    }
    ...
    <div className="mb-10 bg-white rounded-lg shadow-md overflow-hidden">
      ...
      >
        ...
        {map && busStops
          .filter(stop => {
            // Filter stops based on route type
            if (route.id === 2) return stop.name !== "Sector 17 Bus Stand" || stop.isOrigin || stop.isDestination;
        ...
        {/* Special stop for weekend route */}
        {map && route.id === 3 && (
          <Marker
            position={{ lat: 30.7421, lng: 76.8182 }} // Sukhna Lake
            icon={{
            ...
            onClick={() => onStopSelect({
              name: "Sukhna Lake",
              location: { lat: 30.7421, lng: 76.8182 },
      ...
      <div className="mb-6 bg-white rounded-lg shadow-md p-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="bg-blue-50 p-4 rounded-lg">
            ...
            <p><span className="font-medium">Route:</span> Mohali → Sector 43 → Sector 17 → PGI → IT Park</p>
          </div>
          <div className="bg-blue-50 p-4 rounded-lg">
        ...
        <div className="overflow-x-auto">
          <table className="min-w-full bg-white">
            ...
            <tbody className="divide-y divide-gray-200">
              ...
              {/* Add Sukhna Lake as special weekend stop */}
              <tr className="hover:bg-gray-50 bg-gray-50">
                <td className="py-2 px-4">Sukhna Lake</td>
                <td className="py-2 px-4">09:40 AM</td>
                <td className="py-2 px-4">09:50 AM</td>
                <td className="py-2 px-4">Weekend Service only</td>
              </tr>
            </tbody>
          </table>
        </div>
