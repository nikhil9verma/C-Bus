...
const origin = {
  lat: 28.6519, // Latitude for Delhi Railway Station
  lng: 77.2245, // Longitude for Delhi Railway Station
};

// Coordinates for India Gate
const destination = {
  lat: 28.6129, // Latitude for India Gate
  lng: 77.2295, // Longitude for India Gate
};
...
const Bus3 = () => {
  ...
  return (
    <main className="pt-16  pl-2 mr-2">
      <LoadScript
